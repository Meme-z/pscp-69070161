...
```text
Input1:  จำนวนร้าน จำนวนเวลาที่จะตรวจสอบ
Input2+n: เวลาเปิด–ปิดร้าน
Input สุดท้าย: เวลาที่จะตรวจ

Output: มีกี่ร้านเปิดในเวลานั้น
 
Constraints: Output อยู่ในบรรทัดเดียวกัน
```
...
```text
Step 1: รับจำนวนร้าน และจำนวนช่วงเวลาที่ตรวจ
Step 2: รับเวลาเปิดปิดแต่ละร้าน
Step 3: นำเวลาเปิดปิดแต่ละร้านบวกใน list
Step 4: print ว่ามีกี่ร้านเปิดในเวลานั้น
```
...
```text
เหมือนกับแผนแรก ใช้  list ในการเก็บข้อมูลร้านเปิด
```
