...
Output: จำนวนคนที่ได้พิจารณาของขวัญ

Constraints: จะมีคนขโมยของขวัญ
```
...
```text
Step 1: กรอกตัวเลข 3 ตัว
Step 2: ตรวจว่า ตัวเลขสุดท้าย == 1 หรือไม่
Step 3: ตรวจว่า 1+(i*ตัวเลขสอง)%ตัวเลขสุดท้าย == 1 หรือ 1+(i*ตัวเลขสอง)%ตัวเลขสุดท้าย ==  ตัวเลขแรก หรือไม่
Step 4: print จำนวนคนที่ได้พิจารณาของขวัญ
...
```text
เหมือนกับแผนแรก ใช้ modulo เพื่อตรวจว่าโดนขโมยยัง
