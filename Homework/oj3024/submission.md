...
```text
Input: คะแนนรวม
Output: คะแนนสูงสุด (0-10)
Constraints: ต้องหาคะแนนต่ำสุดโดยไม่มีคะแนนตรงกลาง
```
...
```text
Step 1: กรอกคะแนนรวมและคะแนนสูงสุด
Step 2:เช็กว่า คะแนนสูงสุด x 2 น้อยกว่า คะแนนรวมไหม
             ถ้าใช่ คะแนนน้่อยสุด = คะแนนรวม - (คะแนนสูงสุด x 2)
              ถ้าไม่คะแนนน้อยสุด = 0
Step 3: เช็กว่า คะแนนสูงสุด - คะแนนน้อย > 2 ไหม
              ถ้าใช่ Print Surprising
              ถ้าไม่ Print  Not surprising
```
...
```text
เหมือนกับแผนแรก เซ็ตตัวแปรคะแนนต่ำสุดไว้ 0 ข้างนอกเลยไม่ต้องใช้ else
...
```text
เฃ็ค คะแนนต่ำว่าจะต่ำกว่า 0 ไหม
```
