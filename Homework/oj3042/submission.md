...
```text
Input: ตัวเลข
Output: (ตัวเลข//10)*10, ((ตัวเลข//10)-1)*10,...,0
Constraints: Output ต้องอยู่ในบรรทัดเดียวกัน
```
...
```text
Step 1: กรอกตัวเลข
Step 2: ตัวเลขไปหาร10 โดยปัดเศษ
Step 3: นำตัวเลขไป  *10 แล้ว print โดยที่ Output  ต้องอยู่บรรทัดเดียวกัน
...
```text
เหมือนกับแผนแรก ผมใช้ for loop ในการหา  (ตัวเลข//10)*10, ((ตัวเลข//10)-1)*10,...,0 และใช้ end = " " เพื่อให้ Output อยู่ในบรรทัดเดียวกันและคั่นด้วยช่องว่าง
```
