...
Input2: ระยะปลาย B
Input3: ตัวหาร d
Input4: ตัวเศษที่ต้องเหลือ r

Output: ให้ว่ากีมีจํานวนในช่วง [A, B] ที่จํานวน ที่หารด้วยจำนวนนับ d แล้วเหลือเศษ r
...
```text
Step 1: กรอก A B d r
Step 2: ตรวจว่าตัวเลขในระยะ A-B % d == r หรือไม่
Step 3: ถ้าใช่ +1 ในตัวนับ
Step 4: print ว่า มีทั้งหมดกี่จำนวน
...
```text
เหมือนกับแผนแรก ใช้ modulo เพื่อตรวจเศษเมื่อ ตัวเลขในระยะ A-B หารด้วย d ถ้าเศษเป็น r ให้ +1 ตัวนับ
```
