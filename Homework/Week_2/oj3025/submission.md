...
Input2: วัน
Output: season
Constraints: ทุกๆเดือนที่หาร 3 ลงตัว และตั้งแต่วันที่่ 21 เป็นต้นไป ฤดูจะเปลี่ยนไป
```
...
```text
Step 1: กรอก วันและเดือน
Step 2: เช็ค วันและเดือน
              ถ้า เดือน <= 3
                      ss = 0
              ถ้า เดือน <= 6
                      ss = 1
              ...
              ถ้า เดือน <= 12
                      ss = 3
Step 3: เช็คถ้าเดือน % 3 = 0 และ วัน >= 21
                    ss = (ss+1)%4
Step 4: แสดงฤดู
```
...
```text
เหมือนกับแผนแรก ผมใช้ index โดย ตั้ง index ["winter", "spring", "summer", "fall"] และสร้่างตัวแปล ss เพื่อเซ็ต index และ ถ้าเดือนหาร 3 ลงตัวและ ตั้งแต่วันที่ 21 ขึ้นไป ฤดูจะขยับไปฤดูถัดไป
```
...
```text
เช็คว่าฤดูเปลี่ยนไหม (ต้องไม่เปลี่ยน)
```
...
```text
เช็คว่าฤดูเปลี่ยนไหม (ต้องปลี่ยน)
```
