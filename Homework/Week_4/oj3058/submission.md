...
```text
Input 1: รับจำนวนเอิฐก้อนเล็ก
Input 2: รับจำนวนเอิฐก้อนใหญ่
Input 3: รับเป้าหมาย

Output: จำนวนอิฐก้อนเล็กที่ต้องใช้

Constraints: ถ้าไม่สามารถสร้างได้ ตอบ -1
```
...
```text
Step 1: รับจำนวนเอิฐก้อนเล็ก ใหญ่ และ Goal
Step 2: เอา goal มาลบ  อิฐใหญ่ * 5
Step 3: ตรวจว่าต้องใช้เอิฐก้อนเล็กเท่าไร โดย goal -  min(b, goal//5)*5
Step 4: แสดงผลจำนวนที่ต้องใช้  ถ้าเป็นไปไม่ได้แสดง  -1
```
...
```text
เหมือนกับแผนแรก ใช้ minเพื่อหาจำนวนอิฐก้อนใหญ่ ที่ต้องใ้ชหลังจากนั้นไปลบกับ Goal เพื่อหาจำนวนอิฐก้อนเล็ก ที่ต้องใช้
```
...
```text
ตรวจว่าอิฐไม่พอแล้ว print -1 ไหม
```
