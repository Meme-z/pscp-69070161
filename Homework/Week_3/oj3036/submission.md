...
```text
Input: ตัวเลข
Output: กำแพงน้อยที่สุดที่คุณจะต้องพัง
Constraints: ต้องหาวิธีการคำนวณ
```
...
Step 1: กรอกตัวเลข
Step 2: คำนวณหาชั้น
Step 3: คำนวณหาตำแหน่งว่าเลขต่ำแหน่งเป็นคู่หรือคี่
Step 4: ถ้าเป็นคี่ให้ -1 (การนำต่ำแหน่งเริ่มจาก 0)
Step 5: แสดงจำนวนกำแพง
```
...
```text
เหมือนกับแผนแรก ใช้ modulo เพื่อตรวจเลขว่าเป็นคี่หรือคู่ ใช้ while ในการ loop หาชั้น
```
