...
```text
Input1: อุณหภูมิ
Input2: หน่วยอุณหภูมิก่อนเปลี่ยน
Input3: หน่วยอุณหภูมิหลังเปลี่ยน
Output: อุณหภูมิหลังเปลี่ยนหน่วย
Constraints:Output ต้องเป็นทศนิยมสองหลัก
```
...
```text
Step 1: กรอกอุณหภูมิ หน่วยอุณหภูมิก่อนเปลี่ยน หน่วยอุณหภูมิหลังเปลี่ยน
Step 2: เปลี่ยนอุณหภูมินั้นให้เป็น C เพื่อง่ายต่อการคำนวณ
Step 3: นำไปเข้าสูตรหาอุณหภูมิ
Step 4: แสดงผลอุณหภูมิหลังจากเปลี่ยนหน่วย
```
...
```text
หมือนกับแผนแรก ใช้ lower เพื่อรับรองอุณหภูมิพิมพ์เล็กและพิมพ์ใหญ่ ใช้ if else เพื่อเช็กหน่วยอุณหภูมิ
```
...
```text
เพื่อการคำนวณผลเปลี่ยน R เป็น K
```
...
```text
เพื่อการคำนวณผลเปลี่ยน F เป็น R
```
