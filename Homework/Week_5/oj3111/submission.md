...
Output: เงินทีต้องจ่าย

Constraints: ปัดเศษแบบ Round Half Up
```
...
```text
Step 1: กรอกสถานะสมาชิก จำนวนสินค้าที่ซื้อ
Step 2: กรอกราคาสินค้า
Step 3: หากเป็นสมาชิก ลด 5%  ถ้าไม่เป็นสมาชิกตรวจว่ายอดรวมเกิน 500 ไหมถ้าเกินลด 3%
Step 4: print ราคาหลังลด
```
...
```text
เหมือนกับแผนแรก ใช้  import Decimal เพื่้อใช้การปัดแบบ  Round Half Up
```
