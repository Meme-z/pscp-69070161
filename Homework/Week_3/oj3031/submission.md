...
```text
Input 1: จำนวนพื้นที่ที่น้ำหมึกแผ่ขยายไปต่อหนึ่งวินาทีและจำนวนผู้คน
Input 2-n: ตำแหน่งของคน
Output: ระยะเวลาที่จะไปถึงแต่ละตำแหน่ง
Constraints: pi = 3.1416 และ output ต้องเป็นจำนวนเต็ม
```
...
```text
Step 1: กรอกพื้นที่ที่น้ำหมึกแผ่ขยายไปต่อหนึ่งวินาทีและจำนวนคำร้องจากผู้คน
Step 2: กรอกพิกัดของบ้านของคน
Step 3: คำนวณผ่านสูตร
Step 4: แสดงวินาทีที่ถึงพิกัดนั้น
```
...
```text
เหมือนกับแผนแรก โดยใช้ list เพื่อแยก input และใช้ range เพื่อรับจำนวน n คน
```
