...
```text
Input1: กรอกที่จัดส่ง (จาก ถึง)
Input2: น้ำหนักพัสดุ

Output: ราคา (ไม่มีที่จัดส่ง print Error)

Constraints: น้ำหนักเป็นfloat
```
...
```text
Step 1: กรอก ที่อยู่ จัดส่ง และบ้ำหนัก
Step 2: นำน้ำหนักไปคำนวณตามสูตรแล้ว + ค่าจัดส่ง
Step 3: print ค่าจัดส่งหากไม่มีที่อยู่จัดส่ง Print Error
```
...
```text
เหมือนกับแผนแรก ใช้ if else เพื่อกำหนดค่าจัดส่งและน้ำหนักต่อบาทแต่ละที
```
